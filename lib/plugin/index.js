...
var _thumbnail = _interopRequireDefault(require("../images/thumbnail.jpg"));
...
class SupersetPluginChartMixedBarLineCustom extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Superset Plugin Chart Mixed Bar Line Custom',
      name: (0, _core.t)('Mixed Bar Line Custom'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetPluginChartMixedBarLineCustom'))),
      metadata,
