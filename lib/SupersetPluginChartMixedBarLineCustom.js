...
function SupersetPluginChartMixedBarLineCustom(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_recharts.ComposedChart, {
    ...
    }, props.barChartShowValue && /*#__PURE__*/_react.default.createElement(_recharts.LabelList, {
      dataKey: key,
      position: "top",
      formatter: numberFormatter,
      style: {
    ...
    }, props.lineChartShowValue && /*#__PURE__*/_react.default.createElement(_recharts.LabelList, {
      dataKey: key,
      position: "top",
      formatter: numberFormatter,
      style: {
