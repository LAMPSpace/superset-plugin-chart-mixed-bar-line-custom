 ...
 * under the License.
 */
import { SupersetPluginChartMixedBarLineCustom } from '../src';
 ...
 */
describe('superset-plugin-chart-mixed-bar-line-custom', () => {
  it('exists', () => {
    expect(SupersetPluginChartMixedBarLineCustom).toBeDefined();
  });
});
